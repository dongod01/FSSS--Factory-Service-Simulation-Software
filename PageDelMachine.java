...
public class PageDelMachine extends JFrame {
	...
	public PageDelMachine() {
		...
		JLabel lblMachineType = new JLabel("Machine Name :");
		...
		btnAddAnotherMachinetype = new JButton("Delete Another Machine");
		...
		btnAddAdjuster = new JButton("Delete Machine");
		...
		btnAddAdjuster.setBounds(80, 220, 180, 33);
		...
		button.setBounds(301, 220, 89, 33);
