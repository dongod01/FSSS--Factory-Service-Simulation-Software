...
public class SelMachine extends JFrame {
	...
	public SelMachine() {
		...
		btnAddAnotherMachinetype = new JButton("Select Another Machine");
		...
		btnAddAnotherMachinetype.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				//btnAddAnotherMachinetype.setEnabled(true);
		...
		btnAddAdjuster = new JButton("Select Machine");
