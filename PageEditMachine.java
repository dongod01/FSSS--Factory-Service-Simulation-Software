...
public class PageEditMachine extends JFrame {
	...
	public PageEditMachine() {
		...
		btnAddAnotherMachinetype = new JButton("Choose type");
		...
		btnAddAdjuster = new JButton("Edit Machine");
