...
public class PageAddMachine extends JFrame {
	...
	public PageAddMachine() {
		...
		btnAddMachine.setFont(new Font("Tahoma", Font.BOLD, 15));
		...
		lblRepairTimein = new JLabel("Repair Time(Days) :");
		lblRepairTimein.setForeground(new Color(0, 0, 102));
		lblRepairTimein.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblRepairTimein.setBounds(26, 120, 155, 30);
		contentPane.add(lblRepairTimein);
		
		JLabel lblRepairRange = new JLabel("(1-1000) ");
		lblRepairRange.setForeground(new Color(0, 0, 102));
		lblRepairRange.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblRepairRange.setBounds(61, 140 , 155, 30);
		contentPane.add(lblRepairRange);
