...
public class PageDelAdjuster extends JFrame {
	 ...
	 * Create the frame.
	 */
	public PageDelAdjuster() {
		
		setTitle("Delete Adjuster");
		...
		btnAddAnotherMachinetype = new JButton("Delete Another Adjuster");
		...
		btnAddAdjuster = new JButton("Delete Adjuster");
